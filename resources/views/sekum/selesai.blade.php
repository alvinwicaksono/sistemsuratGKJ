        ...
        <div class="card">
          ...
          <div class="card-body table-responsive">
            <table id="example1" class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>Nomor Surat <br>Nama Surat</th>
                  <th>Asal Surat<br>Perihal</th>
                  <th>Tanggal Masuk</th>
                  <th>Aksi</th>
              ...
              @foreach($hasil['data'] as $no => $item)
                <tr>
                  <td>{{$item['nomor_surat']}}<br>{{$item['nama_surat']}}</td>
                  <td>{{$item['sumber_surat']}}<br>
                  ...
                  <td>
                   ...
                   <a href="/aktifitas/{{$item['suratmasuk_id']}}" type="button" class="btn btn-sm btn-block bg-gradient-success mt-2"><i class="fas fa-eye">Aktifitas Surat</i></a>
